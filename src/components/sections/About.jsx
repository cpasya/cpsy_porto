...
import { faHtml5, faCss3, faReact, faJs, faPhp, faLaravel, faNodeJs, faGit, faGithub, faGitAlt, faCpanel, faPlaystation, faFigma } from '@fortawesome/free-brands-svg-icons'
import styled from 'styled-components'
import { faCompassDrafting, faFire, faFireAlt, faFireBurner, faFireFlameCurved, faPeopleGroup, faPlaceOfWorship, faPlay, faPlayCircle } from '@fortawesome/free-solid-svg-icons'
        ...
        <React.Fragment>
            <section id="about" className="about">
                <div className="container" data-aos="fade-up">
                    <div className="section-title">
                        <h2>About</h2>
                        <p>Hello, I'm Pasya. My relationship with Technology started at a senior high school, specifically when I play games almost every time. Grateful, I became Programmer now who proficient in Full Stack Developer for 3 years. And during that times, I really enjoyed when developing Back End of the apps.</p>
                    </div>

                    <div className="row">
                        <div className="col-lg-4">
                            <img src="/assets/img/gwKece.jpg" className="img-fluid" alt="" />
                        </div>
                        <div className="col-lg-8 pt-4 pt-lg-0 content">
                            ...
                            <div className="col-lg-6">
                                <ul>
                                    <li><i className="bi bi-chevron-right"></i> <strong>Age:</strong> <span>72</span></li>
                            ...
                            <div className="col-lg-6">
                                <ul>
                                    ...
                                    <li><i className="bi bi-chevron-right"></i> <strong>Email:</strong> <span><a style={{ color:'blue', textDecoration:'none',  }} href="pasya0129@gmail.com">pasya0129@gmail.com</a></span></li>
                                    <li>
                    ...
                    <div className="row skills-content">
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="row">
                                ...
                                <div className="col-6">
                                    <div className="count-box mt-0">
                                        <FontAwesomeIcon icon={faFigma} style={{ 
                                            background: 'purple',
                                            borderRadius: '50px',
                                            height: '48px',
                                            width: '48px',
            ...
            <section id="facts" className="facts services">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6 d-flex align-items-stretch justify-content-center" data-aos="zoom-in" data-aos-delay="100">
