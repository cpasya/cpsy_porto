        ...
        <section id="portfolio" className="portfolio section-bg">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              <h2>Portfolio</h2>
              <p>So, this is several projects I've done before. Enjoy !</p>
            </div>
            ...
            >
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap">
                  <img
                    src="/assets/img/portfolio/sr.jpeg"
                    className="img-fluid"
                    alt=""
                  />
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap d-flex justify-content-center">
                  <img
                    src="\assets\img\portfolio\kl2.png"
                    className="img-fluid"
                    alt=""
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                <div className="portfolio-wrap">
                  <img
                    src="\assets\img\portfolio\dst.png"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                <div className="portfolio-wrap">
                  <img
                    src="\assets\img\portfolio\ttt.png"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    ...
                    <div className="portfolio-links">
                      <a
                        href="\assets\img\portfolio\ttt.png"
                        data-gallery="portfolioGallery"
                        className="portfolio-lightbox"
                        title="Card 1"
                      >
